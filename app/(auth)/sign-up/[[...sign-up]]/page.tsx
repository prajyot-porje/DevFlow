        ...
        isDark
          ? {
              backgroundImage: `
                ...
                url("data:image/svg+xml,%3Csvg width='24' height='24' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='1' cy='1' r='0.75' fill='%23a1a1aa' fill-opacity='0.03'/%3E%3C/svg%3E")
              `,
            }
          : undefined
      }
        ...
        <SignUp
          appearance={{
            variables: {
              ...
              colorTextOnPrimaryBackground: 'var(--color-accent-foreground)',
            ...
            elements: {
              ...
              formFieldInput:
                'bg-[var(--color-bg-elevated)] border border-[var(--color-border-default)] focus:border-[var(--color-accent)] rounded-md font-body text-base px-4 py-3 focus:shadow-[0_0_0_1px_var(--color-accent),0_4px_12px_rgba(0,0,0,0.1)]',
              formButtonPrimary:
                'bg-[var(--color-accent)] text-[var(--color-accent-foreground)] hover:opacity-90 font-body font-semibold text-sm rounded-md py-3 tracking-wide transition-all duration-100',
